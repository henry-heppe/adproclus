...
#'
#' An initial cluster membership matrix \eqn{\boldsymbol{A}} is generated by
#' finding the best \eqn{\boldsymbol{A}} conditional
#' on an initial profile matrix
#' \eqn{\boldsymbol{P}} generated by drawing \emph{k} randomly chosen, distinct,
